...
Let $kt'\geq T$, then
\begin{align*}
\sum_{t=1}^{T}\nu^t \leq\sum_{t=1}^{kt'}\nu^t \leq OPT + k\cdot 2\sqrt{2^i\ln n}=OPT + k\sqrt{2^i}(2\sqrt{\ln n}) \leq OPT + 2\sqrt{T\ln n}
\end{align*}
The last inequality holds since 
\begin{align*}
\sqrt{T} \geq k\sqrt{2^i} \implies T \geq k^22^i
\end{align*}
