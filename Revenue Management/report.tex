...
\end{align}
Using the relationship between pricing and sales probability, the paper we studies rewrites the expected reveue in terms of corresponding probability scheme $\mathbf{P}=\{P_t, t \in [T,0)\}$ to get
\begin{align}
