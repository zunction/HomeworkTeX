...
\end{align*}
\item Let $Y_n$ be as given in the question and $Y = 0$ (0 distribution). Then we can show $Y_n \leadsto Y$ and $\mathbb{P}(Y=0)=1$ which implies $Y_n \overset{P}{\to} Y$. The cdf of $Y$, $F(t)=1$ for all $t\geq0$ and 0 otherwise.
\begin{align*}
F_n(t) &= \mathbb{P}(Y\leq t) = \sum_{k=0}^{\lfloor \frac{t}{n}\rfloor}e^{-1/n}\frac{(1/n)^k}{k!}\\
